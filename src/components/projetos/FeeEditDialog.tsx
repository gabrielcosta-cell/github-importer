...
type PropagationMode = 'only_this' | 'this_and_previous' | 'this_and_next' | 'all'

const MONTHS_FULL = ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro']

const generateAffectedMonths = (
  ...
  if (dataPerda) {
    ...
    // If no data_perda, limit to current month + 12
    const now = new Date()
...
const getPropagationDescription = (mode: PropagationMode, month: number, year: number): string => {
